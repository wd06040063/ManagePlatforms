...
<div class="data_list">
		...
		<c:choose>
			<c:when test="${dormManager.dormManagerId!=null }">
				<font color="white">修改管理员</font>
			</c:when>
			<c:otherwise>
				<font color="white">添加管理员</font>
			</c:otherwise>
		</c:choose>
		</div>
				...
				<input type="hidden" id="dormManagerId" name="dormManagerId" value="${dormManager.dormManagerId }"/>
					<table align="center" style="color:white">
						...
						<tr>
							...
							<td><input type="text" id="password"  name="password" value="${dormManager.password }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
