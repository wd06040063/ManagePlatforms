...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;background-color:#3a425d;">
	...
	<div class="header">
		...
		<div style="padding-top: 15px;padding-right: 20px;color:white;background-color:#3a425d;">当前用户：&nbsp;<font color="#00b7ee" >${currentUser.userName }</font>，后勤人员</div>
	</div>
</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="repairManager?action=list"><i class="icon-chevron-right"></i>维修管理</a></li>
