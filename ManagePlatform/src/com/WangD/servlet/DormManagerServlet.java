...
import com.WangD.dao.DormManagerDao;
import com.WangD.model.DormManager;
import com.WangD.model.PageBean;
import com.WangD.util.DbUtil;
import com.WangD.util.PropertiesUtil;
...
public class DormManagerServlet extends HttpServlet{
	...
	private String genPagation(int totalNum, int currentPage, int pageSize){
		...
		pageCode.append("<li><a href='dormBuild?page="+totalPage+"'>下一页</a></li>");
