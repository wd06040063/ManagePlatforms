...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;background-color:#3a425d;">
	...
	<div class="header">
		...
		<div style="padding-top: 15px;padding-right: 20px;color:white;background-color:#3a425d;">当前用户：&nbsp;<font color="#00b7ee" >${currentUser.userName }</font>，寝室楼管理员</div>
	</div>
</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="rechargeRecord?action=list"><i class="icon-chevron-right"></i>水卡充值</a></li>
					...
					<div class="span10" style="width=100%;height:90%;">
	...
	<div style="margin-top:10px;">版权所有 © 沈阳师范大学软件学院 All Rights Reserved</div></div></center></font>
</body>
</html>