...
<div class="data_list">
		<div class="data_list_title">
			<font style="color:white">报修管理</font>
		</div>
		<form name="myForm" class="form-search" method="post" action="repairManager?action=search" style="padding-bottom: 0px">
				<button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='repairManager?action=preSave'">添加</button>
				<span class="data_search">
					...
					<span><font style="font-family: '黑体'; font-style: 'bold'; font-size: 20px" color="#00b7ee">${dormBuildName }&nbsp;&nbsp;</font></span>
