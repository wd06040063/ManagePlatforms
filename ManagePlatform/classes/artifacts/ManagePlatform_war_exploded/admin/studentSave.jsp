...
<div class="data_list">
		...
		<c:choose>
			...
			<font color="white">修改学生信息</font>
			</c:when>
			<c:otherwise>
				<font color="white">添加学生</font>
			</c:otherwise>
		</c:choose>
		</div>
				...
				<input type="hidden" id="studentId" name="studentId" value="${student.studentId }"/>
					<table align="center">
						...
						<tr style="color:white">
							...
							<td><input type="text" id="password"  name="password" value="${student.password }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
