...
window.onload = function(){ 
	...
	function recordDelete(recordId) {
		if(confirm("您确定要删除这条记录吗？")) {
			window.location="rechargeRecord?action=delete&recordId="+recordId;
		}
	}
</script>
...
<div class="data_list">
		<div class="data_list_title">
			<font color="white">充值管理</font>
		</div>
		<form name="myForm" class="form-search" method="post" action="rechargeRecord?action=search" style="padding-bottom: 0px">
				<span class="data_search">
					...
					<select id="searchType" name="searchType" style="width: 80px;color:white">
